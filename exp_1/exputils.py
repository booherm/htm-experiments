...
def getRandom2dBoolMatrix(width, height):
	data = numpy.zeros(shape = (width, height), dtype = "bool")
...
def generateMovie(pngFilenamePattern, outputFilename):
	movie(pngFilenamePattern, encoder = "convert", output_file = outputFilename, fps = 24)
