...
updateRules = {
	"0000": ["0000"],
	"1000": ["0001", "1000", "0100", "0010"],
	"0001": ["0001", "1000", "0100", "0010"],
	"0100": ["0001", "1000", "0100", "0010"],
	"0010": ["0001", "1000", "0100", "0010"],
	"1100": ["1100", "0011", "1010", "0101", "0110", "1001"],
	"0011": ["1100", "0011", "1010", "0101", "0110", "1001"],
	"1010": ["1100", "0011", "1010", "0101", "0110", "1001"],
	"0101": ["1100", "0011", "1010", "0101", "0110", "1001"],
	"0110": ["1100", "0011", "1010", "0101", "0110", "1001"],
	"1001": ["1100", "0011", "1010", "0101", "0110", "1001"],
	"0111": ["0111", "1110", "1011", "1101"],
	"1110": ["0111", "1110", "1011", "1101"],
	"1011": ["0111", "1110", "1011", "1101"],
	"1101": ["0111", "1110", "1011", "1101"],
	"1111": ["1111"]
}
...
class Mutator:
	...
	def mutate(self, iteration):
		...
		image_utils.writeBitArray2DImage(bitArray = self.matrix, filename = "img_" + str(imageCounter).zfill(5) + ".png")
		imageCounter += 1
